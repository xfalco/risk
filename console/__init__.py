...
BACK = {"name": "BACK", "value": ConsoleSelection("BACK", ConsoleSelectionType.BACK)}
DONE = {"name": "DONE", "value": ConsoleSelection("DONE", ConsoleSelectionType.DONE)}
            ...
            if "value" in option:
                value = {
                    ...
                    "value": ConsoleSelection(
                        option["value"], ConsoleSelectionType.VALUE
                    ),
                }
