...
menu = {
    ...
    "options": {
        "AFRICA": {
            "name": "Africa (10x)",
            "options": {
                "CONGO": {"name": "Congo thing", "value": "CONGO"},
                "SOUTH AFRICA": {"name": "South Africa thing", "value": "SOUTH AFRICA"},
            },
            "confirm": set_africa,
        },
        "EUROPE": {
            "name": "Europe (20x)",
            "options": {
                "FRANCE": {"name": "France thing", "value": "FRANCE"},
                "GERMANY": {"name": "GERMANY thing", "value": "GERMANY"},
                "SPAIN": {"name": "SPAIN thing", "value": "SPAIN"},
            },
            "confirm": set_europe,
        },
        "NA": {
            "name": "North America and Leave",
            "options": {"US": {"name": "US thing", "value": "US"}},
            "confirm": set_america,
        },
    },
    "confirm": confirm,
